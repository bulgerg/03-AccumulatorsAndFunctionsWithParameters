...
#            window=rg.RoseWindow(x-range, y-range, title) or simply
#            window=rg.RoseWindow() for default setting
#
...
#        necessary?  Why?
#            This method allows you to look at the window after the code
#            finishes running as long as you want
#
