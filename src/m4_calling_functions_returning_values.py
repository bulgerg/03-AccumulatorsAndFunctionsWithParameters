...
def TDD_digits_in_cube(n):
    return sum_of_digits(n**3)

def run_test_TDD_digits_in_cube():
    # Test 1:
    print()
    print('--------------------------------------------------')
    print('Testing the   TDD_digits_in_cube  function:')
    print('--------------------------------------------------')

    expected = 8
    answer = TDD_digits_in_cube(2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
